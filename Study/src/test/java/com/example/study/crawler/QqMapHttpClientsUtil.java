...
public class QqMapHttpClientsUtil {
    ...
    private static void config(HttpRequestBase httpRequestBase) {
        ...
        httpRequestBase.setHeader("Cookie","mpuv=38d5faa4-24fe-469a-f65c-65b18e8040e3");
        httpRequestBase.setHeader("Host","apis.map.qq.com");
        httpRequestBase.setHeader("Referer","https://lbs.qq.com/tool/getpoint/getpoint.html");
        httpRequestBase.setHeader("User-Agent","Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.140 Safari/537.36 Edge/17.17134\"");
...
//                config(httpget);
    ...
    static class GetRunnable implements Runnable {
        ...
        public void run() {
            try {
                System.out.println(QqMapHttpClientsUtil.get(url));
            } finally {
