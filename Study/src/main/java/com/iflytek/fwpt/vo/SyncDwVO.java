 ...
 * @author qingli8
 * @version 1.0
 * @since 2018年10月24日下午4:28:07
 *
 */
public class SyncDwVO {
    ...
    public void setCiLat(String ciLat) {
        this.ciLat = ciLat;
    }

    public String getCiLng() {
        return ciLng;
    }

    public void setCiLng(String ciLng) {
        this.ciLng = ciLng;
    }
